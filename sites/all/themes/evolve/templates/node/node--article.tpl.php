...
$data = $node->field_date["und"][0]["value"];
...
<div id="node-<?php print $node->nid; ?>" style="margin-top:30px;" class="<?php print $classes; ?> clearfix post large" <?php print $attributes; ?>>
    ...
    <div class="post-format">
        <h4 class="mese"><?php print t(date('M', strtotime($data))); ?></h4>
        <h2 class="giorno"><?php print date('d', strtotime($data)); ?></h2>
		<h3 class="anno"><?php print date('Y', strtotime($data)); ?></h3>
    </div>
	
	<section class="post-content">
    <header class="meta">
		   <h2><a><?php print $title; ?></a></h2>
    </header>
	 <?php
		...
		if(isset($node->field_link["und"][0])){
			?> 
		<p><a class="readmorebtn" href="<?php echo $node->field_link["und"][0]["url"];?>" target="_blank"><?php print $readmoretxt; ?></a></p>	
		<?php
		}
